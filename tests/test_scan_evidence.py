...
def test_every_route_outcome_gets_assessed_without_changing_the_existing_decision(outcome, gates, monkeypatch):
    ...
    expected_route["fitness_reconciliation"] = shenai_route.reconcile_fitness_rate(baseline, expected_route)
    ...
    assert doc["debug"].pop("rhythm_comparison")["mode"] == "diagnostic_only"
